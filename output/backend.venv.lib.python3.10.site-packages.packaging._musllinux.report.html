...
<html>
   <head>
      <title>flake8 violations: backend/venv/lib/python3.10/site-packages/packaging/_musllinux.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="backend.venv.lib.python3.10.site-packages.packaging._musllinux.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               backend/venv/lib/python3.10/site-packages/packaging/_musllinux.py
            </a>
         </h1>
